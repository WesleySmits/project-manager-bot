...
exports.fetchGoals = fetchGoals;
exports.getTitle = getTitle;
exports.getDescription = getDescription;
exports.getRelationIds = getRelationIds;
exports.hasRelation = hasRelation;
exports.isCompleted = isCompleted;
exports.getProjectStatusCategory = getProjectStatusCategory;
exports.isBlocked = isBlocked;
exports.isActiveProject = isActiveProject;
...
function getProjectStatusCategory(page) {
    ...
    if (exports.PROJECT_STATUS.ACTIVE.includes(status))
        return 'ACTIVE';
    if (exports.PROJECT_STATUS.READY.includes(status))
        return 'READY';
    if (exports.PROJECT_STATUS.BACKLOG.includes(status))
        return 'BACKLOG';
    if (exports.PROJECT_STATUS.PARKED.includes(status))
        return 'PARKED';
    if (exports.PROJECT_STATUS.DONE.includes(status))
        return 'DONE';
    return 'UNKNOWN';
}
/**
